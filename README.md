...
libraryDependencies += "dev.zio" %% "zio-schema-avro"     % "0.0.5"
libraryDependencies += "dev.zio" %% "zio-schema-bson"     % "0.0.5"
libraryDependencies += "dev.zio" %% "zio-schema-json"     % "0.0.5"
libraryDependencies += "dev.zio" %% "zio-schema-msg-pack" % "0.0.5"
libraryDependencies += "dev.zio" %% "zio-schema-protobuf" % "0.0.5"
libraryDependencies += "dev.zio" %% "zio-schema-thrift"   % "0.0.5"
libraryDependencies += "dev.zio" %% "zio-schema-zio-test" % "0.0.5"
